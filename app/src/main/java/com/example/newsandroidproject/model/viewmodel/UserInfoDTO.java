...
public class UserInfoDTO {
    ...
    public UserInfoDTO(Long userId, String name, Integer role, Long postCount, Long followingCount, Long followedCount, Long loginUser, boolean isFollowedByLoginUser, String avatar) {
        this.userId = userId;
        this.name = name;
        this.role = role;
