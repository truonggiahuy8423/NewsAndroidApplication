...
public class ScrollFollowedFragment extends Fragment {
    ...
    public ScrollFollowedFragment() {
        // Required empty public constructor
    }

    public static ScrollFollowedFragment newInstance() {
        ScrollFollowedFragment fragment = new ScrollFollowedFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_scroll_followed, container, false);
        viewPager = root.findViewById(R.id.vpFollowed);
        setUpAdapter();
        loadDataFromApi();
